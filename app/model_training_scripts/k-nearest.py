...
dump(kNN_model, './../trained_models/k-nearest/model.pkl')
dump(vectorizer, './../trained_models/k-nearest/vectorizer.pkl')

predicted_ham = (predictions == 'ham').sum()
predicted_spam = (predictions == 'spam').sum()

metadata = {
    "model": "K-artimiausių kaimynų klasifikatorius",
    "dataset": dataset,
...
metadata_path = './../trained_models/k-nearest/metadata.json'
